            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                <div className="card-enhanced p-8 animate-scale-in">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-3">
                            <label
                                htmlFor="upload-max-file-size-mb"
                                className="flex items-center gap-2 text-sm font-medium text-text"
                            >
                                <span className="material-symbols-outlined text-base">
                                    data_usage
                        ...
                        <div className="space-y-3">
                            <label
                                htmlFor="upload-max-files-per-upload"
                                className="flex items-center gap-2 text-sm font-medium text-text"
                            >
                                <span className="material-symbols-outlined text-base">
                                    library_add
                ...
                <div
                    className="card-enhanced p-8 animate-scale-in"
                ...
                >
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="flex items-start gap-4">
                                <div className="flex items-center h-6">
                                    <input
                                        ...
                                        type="checkbox"
                                        checked={
                                            settings.enableHotlinkProtection
                                        }
                                        onChange={handleInputChange}
                                        className="w-5 h-5 text-primary bg-background border-2 border-border rounded focus:ring-primary/20 focus:ring-2"
                                    />
                        ...
                        {/* 允许的域名 */}
                        <div
                            className={`transition-all duration-300 ${settings.enableHotlinkProtection ? 'opacity-100 max-h-none' : 'opacity-50 max-h-0 overflow-hidden'}`}
                        >
                            <div className="space-y-3">
                                <label
                ...
                <div
                    className="mt-8 flex justify-end animate-slide-in-up"
